...
alias codespaces="cd /Users/donaldmoore/src/dinglehopper/modules/CODESPACES"
alias copycat="copy"
alias d="print -rl -- ./*(DR/)"
alias dash="code /Users/donaldmoore/src/dinglehopper/modules/BARE/imgnx-universe/dashboard.code-workspace"
...
alias homebrew="brew"
alias hs="/Applications/Hammerspoon.app/Contents/Frameworks/hs/hs"
...
alias ks="killswitch || sudo killall coreaudiod"
alias l.="eza './.??*'" # l. (you might see a bullet point because of a common ligature)
alias l="eza"
alias l="print -rl -- ./*(DR@)"
alias la='eza --long --all -bGF --header --color --group-directories-first --icons'
alias labs='cd "$LABS"'
...
alias mkdir='mkdir -p'
alias mods="cd /Users/donaldmoore/src/dinglehopper/modules"
...
alias rand="node -e \"console.log(Math.random());\""
alias r="\033[0m"
alias rd="print -rl -- ./**/*(D/)"
alias re="reset"
